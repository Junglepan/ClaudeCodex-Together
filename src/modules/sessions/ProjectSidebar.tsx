import { ChevronDown, ChevronRight, Clock, ExternalLink, FolderOpen, LayoutDashboard, Search } from 'lucide-react'
  ...
  return (
    <div className="shrink-0 bg-surface-base flex flex-col h-full" style={{ width }}>
      ...
      <div className="shrink-0 px-3 py-3 border-t border-border-default">
        <a
          href="https://github.com/Junglepan/Claude-Codex-Steward"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 px-2.5 py-2 rounded-md text-xs text-text-tertiary hover:text-text-secondary hover:bg-surface-hover transition-colors"
        >
